...
export default class MultiScanReport {
    ...
    public static createOverviewSheet(storedScans: any, scanType: string, storedScanCount: number, workbook: any) {
        ...
        for (let i=2; i<11; i++) {
            if (i == 7) {
                worksheet.getRow(i).height = 36; // results in a row height of 16
            } else {
        ...
        const rowData = [
            ...
            {key1: 'Platform:', key2: navigator.appVersion},
        ...
        for (let i=2; i<10; i++) {
            ...
            if (i == 7) {
                worksheet.getRow(i).getCell(1).alignment = { horizontal: "left", vertical: "top"};
